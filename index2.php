...
function user_details($config, $oauth_details,$username){
    $path = $config['api_endpoint']."users/?search=".$username;
    $response = make_api_request($oauth_details, $path);
    return $response; 
}

function problems_with_tag($config, $oauth_details,$username){
    $path = $config['api_endpoint']."tags/problems?filter=".$username;
    $response = make_api_request($oauth_details, $path);
    return $response; 
}
...
function main(){
    ...
    $config = array('client_id'=> '',
        'client_secret' => '',
        'api_endpoint'=> 'https://api.codechef.com/',
        'authorization_code_endpoint'=> 'https://api.codechef.com/oauth/authorize',
        'access_token_endpoint'=> 'https://api.codechef.com/oauth/token',
        'redirect_uri'=> 'http://localhost:8000/index2.php',
        'website_base_url' => 'http://localhost:8000/index2.php');
    ...
    if(isset($_GET['code'])){
        ...
        //if(isset($oauth_details['access_token']) == false)
        ...
        //echo($username);
        $response = problems_with_tag($config, $oauth_details,$username);
